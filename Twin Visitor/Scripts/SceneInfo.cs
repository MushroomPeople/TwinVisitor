...
public class SceneInfo : Spatial
{
	...
	[Export]
	public Transform activeSpawn = DataTools.ArrayToTransform(new float[] {1, 0, 0, 0, 1, 0, 0, 0, 1, 4, 0.5f, 0});
	[Export]
	public Transform inactiveSpawn = DataTools.ArrayToTransform(new float[] {1, 0, 0, 0, 1, 0, 0, 0, 1, 0, 0.5f, 0});
